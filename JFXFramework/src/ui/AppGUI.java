...
public class AppGUI implements AppStyleArbiter {
    ...
    protected static Button         newButton;        // button to create a new instance of the application
    protected static Button         saveButton;       // button to save progress on application
    protected static Button         loadButton;       // button to load a saved game from (json) file
    protected static Button         exitButton;       // button to exit application
    protected static Button         infoButton;
     ...
     */
    public static void updateToolbarControls(boolean saved) {
